      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <nav aria-label="Footer navigation" className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <Link href="https://instagram.com/skymarket" target="_blank" rel="noopener noreferrer" className="mt-2 block text-sm text-muted-foreground hover:text-foreground">
              Instagram
            </Link>
            <Link href="https://facebook.com/skymarket" target="_blank" rel="noopener noreferrer" className="mt-2 block text-sm text-muted-foreground hover:text-foreground">
              Facebook
            </Link>
          </div>
        </nav>
